package com.apowo.tuqing.model.data
{
	...
	public final class LocalMapData extends BaseData
	{
		...
		public function LocalMapData(type:int, name:String, cellWidth:int, cellRows:int, cellCols:int, mapArr:Array = null)
		{
			_type = type;
			_name = name;
